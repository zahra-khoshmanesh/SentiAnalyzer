...
## Most expensive colleges with out-of-state tuition
...
tuition_cost %>% group_by(name) %>%
  ...
  coord_flip() +
  labs(y="Tuition cost",x="college name",title = "Top 10 most expensive colleges with out of state tuition") +
  theme(legend.position = "none") 
```
...
tuition_cost %>% group_by(name) %>%
  ...
  coord_flip() +
  labs(y="Tuition cost",x="college name",title = "Top 10 cheapest colleges with out of state tuition") +
  theme(legend.position = "none") 
  
```

## Most expensive colleges with in-state tuition
...
tuition_cost %>% group_by(name) %>%
  ...
  coord_flip() +
  labs(y="Tuition cost",x="college name",title = "Top 10 most expensive colleges with in state tuition") +
  theme(legend.position = "none") 
```

## The cheapest colleges in terms of in-state-tuition
...
tuition_cost %>% group_by(name) %>%
  ...
  coord_flip() +
  labs(y="Tuition cost",x="college name",title = "Top 10 cheapest colleges with in state tuition") +
  theme(legend.position = "none") 
